        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              color: t.text, outline: 'none', width: 180, fontFamily: FONT_MONO,
            }}
          />
        </div>

        <div style={{ overflowX: 'auto' }}>
          <table style={{ minWidth: 500, width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
            <thead>
              <tr>
            ...
            <tbody>
              {filteredCustomers.map((c, i) => (
                ...
                >
                  <td style={{ padding: '9px 10px', color: t.text, fontFamily: FONT_MONO, fontSize: 11, maxWidth: 220, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    {c.pelanggan}
                  </td>
                  ...
                  <td style={{ padding: '9px 10px', textAlign: 'right', color: t.text, fontFamily: FONT_MONO, fontSize: 11, fontWeight: 700 }}>
                    {fmtRpFull(Number(c.total_penjualan ?? 0))}
                  </td>
                  <td style={{ padding: '9px 10px', textAlign: 'right', color: t.textMuted, fontFamily: FONT_MONO, fontSize: 11 }}>
              ...
              {filteredCustomers.length === 0 && (
                <tr>
                  <td colSpan={4} style={{ padding: 32, textAlign: 'center', color: t.textMuted, fontSize: 12, fontFamily: FONT_MONO }}>
                    Tidak ada data
                  </td>
                </tr>
              )}
