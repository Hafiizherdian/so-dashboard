...
await query (`
  CREATE TABLE IF NOT EXISTS wip_jobs (
    ...
    cetak_lbr   NUMERIC(15,2) DEFAULT 0,
    embos_lbr   NUMERIC(15,2) DEFAULT 0,
    plong_lbr   NUMERIC(15,2) DEFAULT 0,
    pretel_pcs  NUMERIC(15,2) DEFAULT 0,
    wip_glue    NUMERIC(15,2) DEFAULT 0,
    wip_total   NUMERIC(15,2) DEFAULT 0,
    bj_pcs      NUMERIC(15,2) DEFAULT 0,
    created_at  TIMESTAMPTZ DEFAULT NOW()
  )
`)
